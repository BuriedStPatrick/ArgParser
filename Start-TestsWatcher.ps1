...
$Path = Convert-Path (Join-Path $PSScriptRoot "src")
...
#        }
    ...
    Write-Debug "Watching for changes to $Path"
    Clear-Host
    . $PSScriptRoot\Start-Tests.ps1
...
finally
{
    ...
    Write-Information "Event Handler disabled, monitoring ends."
}